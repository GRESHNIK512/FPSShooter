...
namespace Game
{
    internal class MagazineAmmoCountChangePlayerSystem : ReactiveSystem<GameEntity>
    {
        private Contexts _context;
        private IGroup<UiEntity> _weaponSlotGroup;

        public MagazineAmmoCountChangePlayerSystem(Contexts contexts) : base (contexts.game)
        {
            _context = contexts;
